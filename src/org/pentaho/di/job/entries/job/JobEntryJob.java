...
public class JobEntryJob extends JobEntryBase implements Cloneable, JobEntryInterface {
  ...
  public Result execute( Result result, int nr ) throws KettleException {
    ...
    //thangtq
      logBasic("executing nr: " + nr + "parentJob:"+parentJob.getName());
    if ( setLogfile ) {
    ...
    try {
      ...
      while ( ( first && !execPerRow )
        ...
        //thangtq
        logBasic("currentJobMapSize: " + result.getResultFiles().size());
    ...
    if ( setLogfile ) {
      if ( logChannelFileWriter != null ) {
        ...
        //thangtq
        logBasic("putting ResultFile:" +  resultFile + "to map:" + " mapSize:"+result.getResultFiles().size());
